...
[![PyPI](https://img.shields.io/pypi/v/cognis-opsecscan.svg)](https://pypi.org/project/cognis-opsecscan/)
[![CI](https://github.com/cognis-digital/opsecscan/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/opsecscan/actions)
...
OPSECSCAN exists for one job — scan documents and file metadata for opsec leaks: geotags, author, gps exif, unit identifiers. — and does it without a SaaS bill or heavyweight setup.
...
```bash
opsecscan --version
opsecscan scan .                      # scan the current project
opsecscan scan . --format json
opsecscan scan . --fail-on high       # non-zero exit for CI gates
opsecscan mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **exiftool + OPSEC checklists**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`opsecscan` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
